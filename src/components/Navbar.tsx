  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-5 md:px-10 h-[68px] bg-[rgba(5,10,26,0.82)] backdrop-blur-xl border-b border-foreground/[0.06]">
      ...
      <div className="flex items-center gap-3">
        <button className="font-body text-sm font-medium text-foreground/75 bg-transparent border border-foreground/15 rounded-pill px-5 py-2 cursor-pointer transition-all hover:bg-foreground/[0.08] hover:text-foreground hover:border-foreground/30">
          Sign in
        </button>
        <Link
          to="/"
